...
const registerTimerSkip = (io: Server, socket: Socket<ClientToServerEvents, ServerToClientEvents>, intervalId:   NodeJS.Timer, counter: number, currentUser: number, participantIdArray: string[]): [ number, number] => {
